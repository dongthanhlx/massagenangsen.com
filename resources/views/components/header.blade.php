<nav class="bg-stone-50 border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-2">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col mt-4 py-2 border border-gray-100 rounded-lg bg-stone-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                <li class="px-4 py-3">
                    <a href="#" class="text-sm space-y-1 text-stone-700 hover:text-cyan-600" aria-current="page">
                        ...
                        <p class="text-xs hidden md:flex">Về Fuji Spa Center</p>
                    </a>
                </li>
                <li class="px-4 py-3">
                    <a href="#" class="text-sm space-y-1 text-stone-700 hover:text-cyan-600">
                        ...
                        <p class="text-xs hidden md:flex">Foot & Body</p>
                    </a>
                </li>
                <li class="px-4 py-3">
                    <a href="#" class="text-sm space-y-1 text-stone-700 hover:text-cyan-600">
                        ...
                        <h3 class="text-center">Chia sẻ</h3>
                        <p class="text-xs hidden md:flex">Mẹo & Kiến thức</p>
                    </a>
                </li>
                <li class="px-4 py-3">
                    <a href="#" class="text-sm space-y-1 text-stone-700 hover:text-cyan-600">
                        ...
                        <p class="text-xs hidden md:flex">Nhận ưu đãi lớn</p>
                    </a>
                </li>
            </ul>
        </div>
